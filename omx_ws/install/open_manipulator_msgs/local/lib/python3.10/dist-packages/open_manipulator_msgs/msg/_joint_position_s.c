...
bool open_manipulator_msgs__msg__joint_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("open_manipulator_msgs.msg._joint_position.JointPosition", full_classname_dest, 55) == 0);
  }
  open_manipulator_msgs__msg__JointPosition * ros_message = _ros_message;
  {  // joint_name
...
PyObject * open_manipulator_msgs__msg__joint_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("open_manipulator_msgs.msg._joint_position");
