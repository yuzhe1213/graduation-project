...
#ifndef OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
#define OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
 ...
 * calls
 * open_manipulator_msgs__srv__SetJointPosition_Request__init().
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetJointPosition_Request__fini()
 ...
 * open_manipulator_msgs__srv__SetJointPosition_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetJointPosition_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * open_manipulator_msgs__srv__SetJointPosition_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetJointPosition_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It allocates the memory for the array and calls
 * open_manipulator_msgs__srv__SetJointPosition_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetJointPosition_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_JOINT_POSITION__FUNCTIONS_H_
