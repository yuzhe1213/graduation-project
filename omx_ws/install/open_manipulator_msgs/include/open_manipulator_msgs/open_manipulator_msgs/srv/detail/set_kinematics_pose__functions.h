...
#ifndef OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_KINEMATICS_POSE__FUNCTIONS_H_
#define OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_KINEMATICS_POSE__FUNCTIONS_H_
...
/// Initialize srv/SetKinematicsPose message.
/**
...
/// Finalize srv/SetKinematicsPose message.
/**
...
/// Create srv/SetKinematicsPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Request__init().
...
/// Destroy srv/SetKinematicsPose message.
/**
 * It calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Request__fini()
...
/// Check for srv/SetKinematicsPose message equality.
/**
...
/// Copy a srv/SetKinematicsPose message.
/**
...
/// Initialize array of srv/SetKinematicsPose messages.
/**
...
/// Finalize array of srv/SetKinematicsPose messages.
/**
 * It calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Request__fini()
...
/// Create array of srv/SetKinematicsPose messages.
/**
 * It allocates the memory for the array and calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetKinematicsPose messages.
/**
 * It calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetKinematicsPose message array equality.
/**
...
/// Copy an array of srv/SetKinematicsPose messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It allocates the memory for the array and calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_open_manipulator_msgs
...
/**
 * It calls
 * open_manipulator_msgs__srv__SetKinematicsPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // OPEN_MANIPULATOR_MSGS__SRV__DETAIL__SET_KINEMATICS_POSE__FUNCTIONS_H_
