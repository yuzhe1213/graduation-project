  ...
  open_manipulator_msgs__srv__GetKinematicsPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    open_manipulator_msgs__srv__GetKinematicsPose_Request * data =
      (open_manipulator_msgs__srv__GetKinematicsPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!open_manipulator_msgs__srv__GetKinematicsPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          open_manipulator_msgs__srv__GetKinematicsPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  open_manipulator_msgs__srv__GetKinematicsPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    open_manipulator_msgs__srv__GetKinematicsPose_Response * data =
      (open_manipulator_msgs__srv__GetKinematicsPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!open_manipulator_msgs__srv__GetKinematicsPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          open_manipulator_msgs__srv__GetKinematicsPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
