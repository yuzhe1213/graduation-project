...
static const _JointPosition_type_support_symbol_names_t _JointPosition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, open_manipulator_msgs, msg, JointPosition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, open_manipulator_msgs, msg, JointPosition)),
  }
};
...
{
  return &::open_manipulator_msgs::msg::rosidl_typesupport_cpp::JointPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, open_manipulator_msgs, msg, JointPosition)() {
  return get_message_type_support_handle<open_manipulator_msgs::msg::JointPosition>();
}
