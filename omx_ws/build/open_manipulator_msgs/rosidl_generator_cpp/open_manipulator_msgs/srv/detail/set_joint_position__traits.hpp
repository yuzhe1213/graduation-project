...
inline void to_yaml(
  const open_manipulator_msgs::srv::SetJointPosition_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const open_manipulator_msgs::srv::SetJointPosition_Request & msg)
{
...
[[deprecated("use open_manipulator_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const open_manipulator_msgs::srv::SetJointPosition_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  open_manipulator_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use open_manipulator_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const open_manipulator_msgs::srv::SetJointPosition_Response & msg)
{
  return open_manipulator_msgs::srv::to_yaml(msg);
}
