...
bool bond__msg__status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("bond.msg._status.Status", full_classname_dest, 23) == 0);
  }
  bond__msg__Status * ros_message = _ros_message;
  {  // header
  ...
  {  // heartbeat_timeout
    ...
    ros_message->heartbeat_timeout = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // heartbeat_period
    PyObject * field = PyObject_GetAttrString(_pymsg, "heartbeat_period");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->heartbeat_period = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * bond__msg__status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("bond.msg._status");
  ...
  {  // heartbeat_timeout
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->heartbeat_timeout);
    {
  ...
  {  // heartbeat_period
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->heartbeat_period);
    {
      int rc = PyObject_SetAttrString(_pymessage, "heartbeat_period", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
